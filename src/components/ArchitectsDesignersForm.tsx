    ...
    return (
      <div className="architects-page">
        <div className="architects-page__inner">
          ...
          <p className="architects-form__success">✅ הטופס נשלח בהצלחה. תודה על ההצטרפות!</p>
        </div>
      </div>
    );
  }
    ...
    <div className="architects-page">
      <div className="architects-page__inner">
        ...
        <form className="architects-form" onSubmit={handleSubmit} noValidate>
          ...
          <p className={`architects-form__error ${errorMessage ? "is-visible" : ""}`}>
            {errorMessage}
          </p>
